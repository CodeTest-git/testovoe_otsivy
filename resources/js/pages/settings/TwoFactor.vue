            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        При включении двухфакторной аутентификации вам будет
                        предложено ввести безопасный PIN-код при входе. Код можно
                        получить в TOTP-совместимом приложении на вашем телефоне.
                    </p>
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        Двухфакторная аутентификация включена. При входе вам
                        потребуется ввести код из TOTP-приложения на вашем
                        телефоне.
                    </p>
